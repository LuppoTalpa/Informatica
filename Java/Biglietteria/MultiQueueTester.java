...
//        MultiQueue mq = new ArrayMultiQueue(3);
//
//        try (Scanner scr = new Scanner(new File("input.txt"))) {
//
...
//                        break;
//                    case "R":
//                        mq.remove(Integer.parseInt(scr.nextLine()));
//                        break;
//                    case "P":
...
//
//        } catch (Exception e) {
//            System.err.println("Errore eccezione: " + e);
//        }
//
//        // ....... da completare ............
//    }
...
//    // Lancia EmptyQueueException se la i-esima coda e` vuota
